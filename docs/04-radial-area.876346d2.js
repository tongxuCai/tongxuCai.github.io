...
function ready(datapoints) {
  ...
  svg.append('path').datum(datapoints).attr('d', line).attr('fill', 'orange').attr('stroke', 'none').attr('opacity', 0.75);
  svg.append('circle').attr('r', 3).attr('cx', 0).attr('cy', 0);
  var bands = [0, 30, 40, 50, 60, 70, 80, 90];
  ...
  svg.append('text').text('NYC').attr('x', 0).attr('y', 8).attr('font-weight', 'bold').attr('text-anchor', 'middle').style('font-size', '30px'); // svg
