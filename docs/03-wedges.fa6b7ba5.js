...
var colorScale = d3.scaleLinear().range(['cyan', 'pink']).domain([35, 85]);
...
function ready(datapoints) {
  ...
  svg.selectAll('.polar-bar').data(datapoints).enter().append('path').attr('d', arc) // .attr('fill', 'url(#svgGradient)')
