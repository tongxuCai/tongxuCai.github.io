...
d3.csv(require('/data/nba.csv')).then(ready).catch(function (err) {
  return console.log('Failed with', err);
});

function ready(datapoints) {}
},{"d3":"../node_modules/d3/index.js","/data/nba.csv":"data/nba.csv"}]},{},["scripts/homework-13/08-fancy-radar.js"], null)
//# sourceMappingURL=/08-fancy-radar.8c0ba244.js.map