...
function ready(datapoints) {
  ...
  svg.append('path').datum(datapoints).attr('d', line).attr('fill', 'orange').attr('opacity', 0.2).attr('stroke', 'lightgrey');
  ...
  svg.selectAll('.radius-line').data(angleScale.domain()).enter().append('line').attr('x1', 0).attr('y1', 0).attr('x2', 0).attr('y2', -radius).attr('stroke', 'lightgrey').attr('transform', function (d) {
